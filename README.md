...
**Branches**: this branch (`main`) targets **Oracle Linux 8/9 with Python 3**.
Oracle Linux 7 (Python 2) is supported by the legacy **python2** branch.
See [INSTALL.md](INSTALL.md) for the installation steps.
